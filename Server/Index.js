...
const userReportRoute=require('./src/Routes/Report.js')
const sellerReportRoute=require('./src/Routes/Report.js')
const app=express()
...
app.use("/userreport",userReportRoute)
app.use("/sellerreport",sellerReportRoute)
